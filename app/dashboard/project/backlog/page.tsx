...
import { FiMenu } from "react-icons/fi"; // Sürükle ikonu (Handle) için
...
export default function BacklogPage() {
  ...
  // Öncelik rozetleri için renk ataması
  ...
  // Atanan kişinin baş harfini alma
